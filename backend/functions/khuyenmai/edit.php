    ...
    <div class="row">
      ...
      <main role="main" class="col-md-10 ml-sm-auto px-4 mb-2">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Sửa thông tin Khuyến mãi</h1>
        </div>
      ...
      <?php
        // Truy vấn database
          ...
          $km_ma = $_GET['km_ma'];
          $select = <<<EOT
          SELECT km_ten, km_noidung, km_tungay, km_denngay
          FROM khuyenmai WHERE km_ma=$km_ma ;
EOT;
      ...
      ?>
        ...
        <form action="" method="post" name="frmCreate" id="frmCreate">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="km_ten" name="km_ten" aria-describedby="km_tenHelp" value="<?= $selectRow['km_ten']?>">
            <small id="km_tenHelp" class="form-text text-muted">Nhập ít nhất 5 ký tự</small>
          </div>
          <div class="form-group">
            <label for="km_noidung">Nội dung khuyến mãi</label>
            <input type="text" class="form-control" id="km_noidung" name="km_noidung" aria-describedby="km_noidungHelp" value="<?= $selectRow['km_noidung']?>">
