  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <main role="main" class="col-md-10 ml-sm-auto px-4 mb-2">
        ...
        $sqlSelectGopY = "select * from gopy where gy_ma = $gy_ma";
        $resultGopY = mysqli_query($conn, $sqlSelectGopY);
        $rowGopY = mysqli_fetch_array($resultGopY, MYSQLI_ASSOC);
        ...
        */
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="gy_hoten" name="gy_hoten" placeholder="Họ tên" value="<?= $rowGopY['gy_hoten']?>">
        </div>
        <div class="form-group">
            <label for="gy_email">Email</label>
            <input type="text" class="form-control" id="gy_email" name="gy_email" placeholder="Email" value="<?= $rowGopY['gy_email']?>">
        </div>
        <div class="form-group">
            <label for="gy_diachi">Địa chỉ</label>
            <input type="text" class="form-control" id="gy_diachi" name="gy_diachi" placeholder="Địa chỉ" value="<?= $rowGopY['gy_diachi']?>">
        </div>
        
        <div class="form-group">
            <label for="gy_dienthoai">Điện thoại</label>
            <input type="text" class="form-control" id="gy_dienthoai" name="gy_dienthoai" placeholder="Điện thoại góp ý" value="<?= $rowGopY['gy_dienthoai']?>">
        </div>
        <div class="form-group">
            <label for="gy_tieude">Tiêu đề</label>
            <input type="text" class="form-control" id="gy_tieude" name="gy_tieude" placeholder="Tiêu đề góp ý" value="<?= $rowGopY['gy_tieude']?>">
        </div>
        <div class="form-group">
            <label for="gy_noidung">Nội dung</label>
            <input type="text" class="form-control" id="gy_noidung" name="gy_noidung" placeholder="Nội dung" value="<?= $rowGopY['gy_noidung']?>">
        </div>
        <div class="form-group">
            <label for="gy_ngaygopy">Ngày góp ý</label>
            <input type="text" class="form-control" id="gy_ngaygopy" name="gy_ngaygopy" placeholder="Ngày góp ý" value="<?= $rowGopY['gy_ngaygopy']?>">
        </div>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="cdgy_ma" name="cdgy_ma">
                <?php foreach ($dataChuDeGopY as $chudegopy) : ?>
                    <option value="<?= $chudegopy['cdgy_ma'] ?>"<?php if($rowGopY['cdgy_ma']==$chudegopy['cdgy_ma']) echo"selected"?>
                    >
                      <?= $chudegopy['cdgy_ten'] ?>
                    </option>
                <?php endforeach; ?>
        ...
        <?php
          ...
          // Nếu không có lỗi VALIDATE dữ liệu (tức là dữ liệu đã hợp lệ)
            ...
            SET		
              ...
              gy_email='$gy_email',
              gy_diachi='$gy_diachi',              
              gy_dienthoai='$gy_dienthoai',
              gy_tieude='$gy_tieude',
              gy_noidung='$gy_noidung',
              gy_ngaygopy='$gy_ngaygopy',
              cdgy_ma='$cdgy_ma'
            WHERE gy_ma=$gy_ma;
EOT;
