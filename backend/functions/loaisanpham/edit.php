    ...
    <div class="row">
      ...
      <main role="main" class="col-md-10 ml-sm-auto px-4 mb-2">
        ...
        */
        ...
        $lsp_ma = $_GET['lsp_ma'];
        $select = "SELECT lsp_ma, lsp_ten, lsp_mota	FROM loaisanpham WHERE lsp_ma = $lsp_ma;";
        ...
        <form action="" method="post" name="frmCreate" id="frmCreate">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="lsp_ten" name="lsp_ten" value="<?= $selectRow['lsp_ten']?>" aria-describedby="lsp_tenHelp">
            <small id="lsp_tenHelp" class="form-text text-muted">Nhập ít nhất 5 ký tự</small>
          </div>
          <div class="form-group">
            <label for="lsp_mota">Mô tả loại sản phẩm</label>
            <textarea type="text" class="form-control" id="lsp_mota" name="lsp_mota" aria-describedby="lsp_motaHelp"><?= $selectRow['lsp_mota']?></textarea>
