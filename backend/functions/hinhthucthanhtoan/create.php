      ...
      <main role="main" class="col-md-10 ml-sm-auto px-4 mb-2">
        ...
        <form action="" method="post" name="frmCreate" id="frmCreate">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="httt_ten" name="httt_ten" aria-describedby="httt_tenHelp">
            <small id="httt_tenHelp" class="form-text text-muted">Nhập tên hình thức thanh toán</small>
          </div>
