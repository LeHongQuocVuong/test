      ...
      <main role="main" class="col-md-10 ml-sm-auto px-4 mb-2">
        ...
        */
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="os" name="os" placeholder="Hệ điều hành">
        </div>

        <div class="form-group">
            <label for="camera_sau">Camera sau</label>
            <input type="text" class="form-control" id="camera_sau" name="camera_sau" placeholder="Camera sau">
        </div>

        <div class="form-group">
            <label for="camera_truoc">Camera trước</label>
            <input type="text" class="form-control" id="camera_truoc" name="camera_truoc" placeholder="Camera trước">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="ocung" name="ocung" placeholder="Ổ cứng">
        </div>
...
EOT;
            ...
            $sp_ma = $conn->insert_id;

            // Câu lệnh INSERT
            $sqlChiTiet = <<<EOT
            INSERT INTO chitietsanpham
            (sp_ma, manhinh, os, camera_sau, camera_truoc, cpu, ram, ocung, pin)
            VALUES ($sp_ma, '$manhinh', '$os', '$camera_sau', '$camera_truoc', '$cpu', '$ram', '$ocung', '$pin');
EOT;
            // Thực thi INSERT
